                        ...
                        <div class="row">
                            <aside class="col-md-3 col-sm-4 has_mega_menu">
                                ...
                                <section class="section_offset">
                                    ...
                                    <footer class="bottom_box">
                                        <a href="{{ route('proizvoditeli') }}" class="button_grey middle_btn">Виж всички
                                            Производители</a>
                                    </footer>
                                    <!--/ .tags_container-->
                                </section>
                            ...
                            <main class="col-md-9 col-sm-8">
                                            ...
                                            <div class="v_centered">
                                                ...
                                                <div>
                                                    <select name="paginate_by" id="paginate_by">
                                                        <option value="15" @if ($paginate=='15' ) selected @endif>15
                                                        </option>
                                                        <option value="30" @if ($paginate=='30' ) selected @endif>30
                                                        </option>
                                                        <option value="60" @if ($paginate=='60' ) selected @endif>60
                                                        </option>
                                                    </select>
                                                </div>
                                            </div>
                                ...
                                <footer class="bottom_box on_the_sides">
                                    <div class="left_side">
                                        <p>Покажи {{ $products->firstItem() }} до {{ $products->lastItem() }} от
                                            {{ $products->total() }} ({{ $products->lastPage() }} страници)</p>
                                    </div>
