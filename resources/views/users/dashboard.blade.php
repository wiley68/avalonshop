					...
					<div class="row">
						...
						<main class="col-md-9 col-sm-8">
                            ...
                            <section class="theme_box">
								...
								<p>От Вашия Панел на потребителски профил, Вие ще имате възможност да следите историята на Вашите поръчки, да променяте всички ваши лични данни, и да управлявате Вашия профил.</p>
							</section><!--/ .theme_box -->
							<!-- - - - - - - - - - - - - - Contact information - - - - - - - - - - - - - - - - -->
							<section class="theme_box">
								...
								<div class="buttons_row">
									<a href="#" class="button_grey middle_btn">Промяна на данни</a>
									<a href="{{ route('change-password') }}" class="button_grey middle_btn">Промяна на парола</a>
								</div>
							</section><!--/ .theme_box -->
								...
								<div class="table_row">
									<div class="table_cell">
										...
										<section>
											...
											<a href="#" class="button_grey middle_btn">Промени абонамента</a>
										</section>
										<!-- - - - - - - - - - - - - - End of newsletter - - - - - - - - - - - - - - - - -->
									</div><!--/ .table_cell -->
									<div class="table_cell">
										...
										<section>
											<h4>Адресни данни</h4>
											<a href="#" class="button_grey middle_btn">Промени данните</a>
										</section>
										<!-- - - - - - - - - - - - - - End of address book - - - - - - - - - - - - - - - - -->
									</div><!--/ .table_cell -->
								</div><!--/ .table_row -->
								<div class="table_row">
									...
									<div class="table_cell">
										...
										<section>
											...
											<p>{{ Auth::user()->city }},&nbsp;{{ Auth::user()->address }},&nbsp;{{ Auth::user()->phone }}</p>
											<a href="#" class="button_grey middle_btn">Промени адреса</a>
										</section>
