                                        ...
                                        <ul>
                                            ...
                                            <li class="row">
                                                <div class="col-xs-12">
                                                    ...
                                                    <div class="form_el">
                                                        <input type="number" id="user_postcode" name="user_postcode"
                                                            class="form-control" maxlength="4" value="{{ Auth::user()->postcode }}">
                                                    </div>
                                                </div>
                                            </li>
                                            <li class="row">
                                            ...
                                            <li class="row">
                                                <div class="col-xs-12">
                                                    ...
                                                    <div class="form_el">
                                                        <input type="number" id="user_eik" name="user_eik" maxlength="20"
