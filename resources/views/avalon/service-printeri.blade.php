                    ...
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <main class="col-md-9 col-sm-8">
                                <h1>Сервиз принтери</h1>
                                <div class="theme_box clearfix">
                                    <h4>РЕМОНТ НА ПРИНТЕРИ И ОФИС ТЕХНИКА. СМЯНА НА ДЕФЕКТНИ КОМПОНЕНТИ. РЕМОНТ НА
                                        ПОВРЕДЕНИ ЧАСТИ ОТ
                                        МЕХАНИКАТА. ПРЕИНСТАЛИРАНЕ НА ДРАЙВЕРИ. РЕЦИКЛИРАНЕ И ВЪЗСТАНОВЯВАНЕ НА ТОНЕР
                                        КАСЕТИ.</h4>
                                    <h2>Собствена база за ремонт и сервизиране на принтерна техника</h2>
                                    <p>„Авалон“ ООД изгради собствена база за ремонт и сервизиране на принтерна техника
                                        и консумативи за
                                        нея. Целта ни е да подобрим обслужването на нашите клиенти.</p>
                                    <p>Екипът ни от специалисти в областта на принтиращата техника е с изключително
                                        голям опит. Сервизните
                                        ни техници са добре обучени в диагностиката, ремонт и инсталиране
                                        на<br>принтираща техника. Поради
                                        спецификата на работата по поддръжка на такава техника обслужваме част от нашите
                                        клиенти директно на
                                        място в техните офиси. Гордеем се с това , че немалка част от тях са ни клиенти
                                        за период от много
                                        години.</p>
                                    <p>„Авалон“ ООД има подписани договори за Абонаментно техническо обслужване с голяма
                                        част от фирмите в
                                        региона на Велико Търново, Горна Оряховица, Лясковец. Това им дава право да се
                                        ползват с
                                        преференциални цени при закупуването на принтираща техника и консумативи за нея.
                                        Ние сме една от
                                        малкото фирми, които работят директно по сервизното обслужване на повечето от
                                        предприятията в
                                        региона ни. Изградили сме специална мобилна база за доставка на консумативи на
                                        място, без да
                                        изискваме ненужни ангажименти от тяхна страна. Поради тази причина имаме тяхното
                                        доверие и се
                                    ...
                                    <ul>
                                        ...
                                        <li>Консултации по подбиране на най-подходяща за конкретни работни условия
                                            принтираща техника/li&gt;
                                        </li>
