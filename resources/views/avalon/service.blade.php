                    ...
                    <div class="container">
                        ...
                        <div class="row">
                                ...
                                <section class="section_offset">
                                    ...
                                    <ul class="theme_menu">
                                        ...
                                        <li><a href="{{ route('avalon.shop') }}">Магазин Горна
                                                Оряховица</a></li>
                                        <li class="current"><a href="{{ route('avalon.service') }}">Компютърен сервиз</a></li>
                            ...
                            <main class="col-md-9 col-sm-8">
                                <h1>Компютърен сервиз</h1>
                                <div class="theme_box clearfix">
                                    <h4>Ремонт на компютърна техника. Смяна на дефектни компоненти. Ремонт на повредени
                                        компютърни части.
                                    ...
                                    <p>„Авалон“ ООД изгради собствена база за ремонт и сервизиране на компютърна техника
                                        и периферните и
                                        устройства. Целта ни е да подобрим обслужването на нашите клиенти.</p>
                                    <p>Най-ценното ни притежание е екипа от отлично обучени специалисти с повече от
                                        десет годишен опит всеки
                                        в своята област. Всеки един от нашия екип е с нас повече от десет години, като
                                        за това време е
                                        получил огромен опит и познания в областта на диагностиката, ремонт и
                                        инсталиране на компютърната
                                        техника. За този период от време сме се старали, и мислим, че в голямата си част
                                        сме постигнали
                                        личния контакт и взаимно уважение с повечето си клиенти. Гордеем се с това , че
                                        немалка част от тях
                                        са ни клиенти за период от много години.</p>
                                    <p>„Авалон“ ООД има подписани договори за Абонаментно техническо обслужване с голяма
                                        част от фирмите в
                                        региона на Велико Търново, Горна Оряховица, Лясковец. Ние сме една от малкото
                                        фирми, които работят
                                        директно по сервизното обслужване на повечето от предприятията в региона ни.
                                        Изградили сме специална
                                        мобилна база за ремонт и поддръжка на фирмите на място, без да изискваме ненужни
                                        ангажименти от
                                        тяхна страна. Поради тази причина имаме тяхното доверие и се радваме на взаимно
                                        уважение. Референтни
