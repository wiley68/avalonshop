                        ...
                        <div class="row">
                            <aside class="col-md-3 col-sm-4">
                                ...
                                <section class="section_offset">
                                    <h3>Информация</h3>
                                    <ul class="theme_menu">
                                        <li class="current"><a href="{{ route('for_us') }}">За нас</a></li>
                            ...
                            <main class="col-md-9 col-sm-8">
                                    ...
                                    <div class="theme_box clearfix">
                                        <img src="data:image/png;base64,R0lGODlhAQABAAD/ACwAAAAAAQABAAACADs=" 
                                        data-src="/images/office.jpg" class="alignleft" width="310" alt="">
                                        <h4 style="text-align: center;">ФИРМА АВАЛОН ООД Е РЕГИСТРИРАНА СЪГЛАСНО ИЗИСКВАНИЯТА НА БЪЛГАРСКОТО ЗАКОНОДАТЕЛСТВО И Е СПЕЦИАЛИЗИРАНА В РЕДИЦА НАПРАВЛЕНИЯ ОТ СФЕРАТА НА КОМПЮТЪРНИТЕ ТЕХНОЛОГИИ.</h4>
                                        <p>Основана през 2003 г., днес фирма “Авалон” заема водеща позиция на пазара на информационни технологии в региона на градовете Лясковец, Горна Оряховица, и Велико Търново. Като доставчик на комплексни решения – хардуер, софтуер, комуникации, и поддръжка. Високото качество и надеждност на предлаганите продукти даде възможност да се въведе дву или тригодишна гаранция за предлаганите от фирмата асемблирани системи.</span></p>
                                        <p>Фирмата разполага с екип от изключително добре подготвени специалисти работили повече от петнадесет години в бранша. Това, както и изключителната коректност на Вас клиентите, позволява вече повече от десет години фирма “Авалон” да реализира ръст в продажбите си. Над 80% от продажбите и услугите на фирма “Авалон” са насочени към корпоративни потребители, а останалите се реализират чрез soho пазара. Преобладаващата част от търговията на фирма “Авалон” с крайни клиенти е в сектора на частния бизнес. Там изискванията към доставчика, неговите продукти и услуги са изключително високи. Голяма част от енергията на фирмата е пряко насочена към т.нар. “project business”.</p>
                                        <p>Фирма “Авалон” е българска фирма и като субект от сферата на информационната индустрия в региона, развива услуги отговарящи на изискванията на клиентите си относно качество, професионализъм и компетентност. Основа на дейността на фирмата и на успеха и, е защитата на интересите на клиентите си.</p>
                                        <p>Качеството на работата е всеобщо задължение във фирма “Авалон”, от което се определя и отговорността на всеки един от нейните служители.</p>
                                        ...
                                        <ul>
                                            ...
                                            <li>Изграждане на завършена комуникационна инфраструктура с принадлежащите към нея информационни системи (мрежи за пренос на данни/net-tel./)</li>
                                            <li>Изграждане на мрежи за видео наблюдение и видео охрана</li>
                                            <li>Изработване на софтуер по поръчка на клиента. Проектиране и пускане в експлоатация на WEB страници</li>
                                            ...
                                            <li>SEO услуги</li>
                                            <li>За улеснение на своите клиенти предлага собствен електронен магазин (avalonbg.com), даващ възможност за лесна и бърза търговия директно през интернет</li>
                                        </ul>
                                        <h3 style="margin-bottom: 20px;"><strong>Като доказателство за професионалност и компетентност в работата си фирма “Авалон” се задължава да:</strong></h3>
                                        <ul>
                                            <li>изпълнява услуги и подава желаните информации на своите вътрешни и външни клиенти бързо, точно и в подходяща форма;</li>
                                            <li>разглежда като решаващ за успеха си фактор задоволяването и доверието на своите клиенти чрез осигуряване на качество и постоянно подобряване на своята работа;</li>
                                            <li>създава добра работна атмосфера за своите служители, изразяваща се във взаимно доверие и зачитане, съвместна работа, подобряване на комуникациите, постоянно повишаване на квалификацията, спазване на изискванията за сигурност, охрана на труда, опазване на околната среда, ангажираност към качествена работа, признание на лични и колективни успехи;</li>
                                            <li>проверява ефективността на своите услуги и тяхната пригодност да изпълняват изискванията и очакванията на клиентите;</li>
                                            <li>избягва конфликти на интереси и приема само поръчки, които могат да бъдат изпълнени компетентно и професионално; </li>
                                            <li>помага на всички служители при откриване и отстраняване на грешки и източници на такива, за да може да бъдат избягвани за в бъдеще;</li>
                                        </ul>
                                        <br />
                                        <div style="background-color: #eeeeee; padding: 4px 20px 10px 20px; border: thin solid #C4C4C4;">
                                            <h3>НАШЕТО МОТО</h3>
                                            <p>За да сме полезни на всеки клиент, трябва да предлагаме висококачествени продукти и услуги на разумна цена, както и да се грижим за тях винаги и навсякъде.<br />До този момент във фирмата няма получено нито едно възражение или анулиране на сделка поради некоректност от страна на фирма Авалон ООД.</p>
                                        </div>
                                        <br />
                                        <hr />
                                        <br />
