...
@auth
<p>Междувременно можете да използвате следния линк за проследяване на състоянието на Вашата поръчка. Към <a href="{{ route('show-order', ['id' => $orderuser->order]) }}">поръчката</a></p>
@endauth
<div>
...
@php
    ...
    switch ($orderuser->payment) {
        case 'platez':
            ...
            break;
        case 'bank':
            $payment = 'Плащане по Банков път. Банка: УниКредит Булбанк клон Горна Оряховица, IBAN: BG20UNCR70001520104558, BIC: UNCRBGSF, Основание: Поръчка №: ' . $orderuser->order;
            break;
        case 'tbi':
