		...
		<section class="section_offset animated transparent" data-animation="fadeInDown">
			...
			<div class="tabs type_3 products">
				...
				<ul class="theme_menu tabs_nav clearfix">
					<li class="has_submenu"><a href="#tab-1">Категория 1</a></li>
					<li class="has_submenu"><a href="#tab-2">Категория 2</a></li>
					<li class="has_submenu"><a href="#tab-3">Категория 3</a></li>
					<li class="has_submenu"><a href="#tab-4">Категория 4</a></li>
					<li class="has_submenu"><a href="#tab-5">Категория 5</a></li>
					<li class="has_submenu"><a href="#tab-6">Категория 6</a></li>
					<li class="has_submenu"><a href="#tab-7">Категория 7</a></li>
