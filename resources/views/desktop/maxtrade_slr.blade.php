    ...
    <div class="container">
        ...
        <div class="section_offset clearfix">
            ...
            <div class="theme_box clearfix">
                <p><a class="btn btn-primary" style="width: 100%;" href="{{ route('product', ['id' => 'max-slr']) }}" rel="noopener"> Maxtrade SLR<br />240.00 лв. с ДДС </a></p>
        ...
        <div class="call_to_action">
            <div class="on_the_sides">
                ...
                <div class="right_side">
                    <a href="{{ route('product', ['id' => 'max-slr']) }}" class="button_blue huge_btn"><i class="icon-basket-1"></i>Купи сега!</a>
                </div>
            </div>
        </div>
        ...
        <div class="call_to_action type_2 on_the_sides">
            ...
            <div class="right_side">
                @php
                    if (!empty(Product::where(['code' => 'max-slr'])->first())){
                        $download_counts = Product::where(['code' => 'max-slr'])->first()->downloads;
                    }else{
                        $download_counts = 0;
                    }
                @endphp
